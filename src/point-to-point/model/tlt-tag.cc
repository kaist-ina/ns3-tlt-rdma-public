...
{
	return sizeof(m_type)+sizeof(m_control_type)+sizeof(debug_socketId);
}
...
void TltTag::SetControlType(uint8_t ttl)
{
	m_control_type = ttl;
}

uint8_t TltTag::GetControlType()
{
